...
describe('Mouse Operations', () => {
  ...
  it.skip('Double click (not working for me)', () => {
    cy.visit(
    ...
    //   .find("button[ondbclick='myFunction()']")
    //   .trigger('dbclick');
  ...
  it.skip('Drag and Drop using plugin (not working for me)', () => {
    cy.visit(
  ...
  it('Scrolling Page', () => {
    ...
    cy.get(
      ':nth-child(2) > tbody > :nth-child(49) > :nth-child(1) > img'
    ...
    cy.get(
      ':nth-child(2) > tbody > :nth-child(4) > :nth-child(1) > img'
    ).scrollIntoView({ duration: 2000 });
    cy.get(
      ':nth-child(2) > tbody > :nth-child(4) > :nth-child(1) > img'
    ).should('be.visible');
